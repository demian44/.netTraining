...
using MVC.CODEFIRST.DAL;
using MVC.CODEFIRST.Models;

namespace MVC.CODEFIRST.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            var enrollment = db.Enrollment.Include(e => e.MdlStudent);
        ...
        {
            ViewBag.EstudentID = new SelectList(db.Student, "EstudentID", "Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "EnrollmentID,DateEnrollment,EstudentID")] Enrollment enrollment)
        {
